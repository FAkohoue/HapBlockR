...
subtitle: "Choosing parents and crosses with haplotype-aware tools : Edition: 1"
...
---
<!-- HAPBLOCKR_TABLE_FORMATTING_START -->
<style>
...
<!-- HAPBLOCKR_TABLE_FORMATTING_END -->
...
## Externally analysed target values
...
# The nine decision tools and their variants
...
## Coverage-only genetic-algorithm parent selection
...
## Family or genetic-cluster quota selection
...
# Interpreting quality control and uncertainty
...
## Choosing phased or dosage-based analysis
...
## Ploidy and allele representation
...
## Building relevance across families, cycles and environments
...
## From haplotype association to biological explanation
...
## Evidence density and sample support
...
# Supporting tools and complete function map
...
## Genotype import and scalable backends
...
## LD calculation and haplotype-block definition
...
## Phasing, haplotype extraction and harmonisation
...
## Haplotype association and candidate-region tools
...
## Genomic prediction, validation and local effects
...
## Multi-trait and environment-aware decisions
...
| `"dgsi"` | Desired-Gain Selection Index (DGSI) optimisation through DesiredGainR | Automatically selected best replicate, optimised coefficients, realised response, objective trace, rank correlation, coefficient stability and selected-set agreement |
...
DesiredGainR executes `n_rep` independent searches, evaluates the complete
desired-response objective and returns the replicate with the smallest
objective automatically. The other replicates remain in compact diagnostics
so that the breeder can assess convergence and stability. In threshold mode,
trait thresholds define eligibility first; the optimised index then ranks
eligible candidates and retains the requested number.
...
vector. This prevents an automatically positive squared term from rewarding
...
## Operational mating feasibility
...
## Stability, simulation and validation contracts
...
## Metadata, exchange and output utilities
