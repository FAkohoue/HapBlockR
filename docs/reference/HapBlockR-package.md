# HapBlockR: Genome-Wide LD Block Detection, Haplotype Analysis, Genomic Prediction, and Breeding Decision Support
...
reconstruction, diversity metrics, prediction feature matrices,
multi-format genotype I/O, and a downstream breeding-decision layer
(optimal contribution selection, genomic mating usefulness criterion,
Pareto/core-collection parent-set selection).
...
- Report bugs at <https://github.com/FAkohoue/HapBlockR/issues>
