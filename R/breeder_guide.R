...
# breeder_guide.R
#
# The PDF and Word editions of the HapBlockR Breeder's Guide are standalone
# companions to the
# *From Local GEBV to a Crossing Decision* vignette: eight parent- and
# cross-selection tools (truncation selection, GA-based parent selection,
# family- or cluster-quota selection, usefulness_criterion(),
# select_parents_ocs(), select_parents_pareto(), validate_crosses_exact(),
# and select_core_collection()), explained in plain language for readers who
# will make or approve a crossing decision but do not themselves run R.
#
# The installed editions are generated from
# inst/guide/HapBlockR_Breeder_Guide.md by
# tools/build_breeder_guide_accessible.cjs and
# tools/build_breeder_guide_docx.py. They are standalone companions rather
# than R vignettes; open_breeder_guide() locates either edition without
...
#' \code{inst/guide/HapBlockR_Breeder_Guide.md}; both generated files ship in
#' \code{inst/extdata/} and are located via
