#' HapBlockR: Genome-Wide LD Block Detection, Haplotype Analysis, Genomic
#' Prediction, and Breeding Decision Support
#'
#' @description
...
#' diversity metrics, prediction feature matrices, multi-format genotype I/O,
#' and a downstream breeding-decision layer (optimal contribution selection,
#' genomic mating usefulness criterion, Pareto/core-collection parent-set
#' selection).
#'
...
#' @importFrom stats cor median quantile na.omit setNames var aggregate sd lm coef residuals pt pnorm pchisq chisq.test as.dist hclust cutree anova pf prcomp loess nls nls.control predict
...
utils::globalVariables(c(
  ...
  # ggplot2 aes() bare variable names in plot_block_funnel():
  "effect", "var_scaled", "important",
  # ggplot2 aes() bare variable names in plot_parent_selection_pca():
  "PC1", "PC2", "group",
  # ggplot2 aes() bare variable names in plot_ga_vs_ts_simulation():
  "generation", "mean_gebv", "scheme", "max_gebv",
  # ggplot2 aes() bare variable name in plot_selection_clusters():
  "Cluster"
))
